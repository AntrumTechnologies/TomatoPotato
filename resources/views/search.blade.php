        ...
        <div class="col-md-8">
            <form method="get" action="{{ route('search') }}">
                <div class="input-group mb-3">
                    <input class="form-control @error('query') is-invalid @enderror" id="query" name="query" type="text" placeholder="What's cooking?" value="@if(old('query')){{ old('query') }}@else{{ $query }}@endif" required>
